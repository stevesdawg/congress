...
class OutlayBreakdown(db.Model):
    ...
    nat_def_perc_outlays = db.Column(db.Integer)
    nat_def_perc_gdp = db.Column(db.Integer)

    hum_res = db.Column(db.Integer)
    hum_res_perc_outlays = db.Column(db.Integer)
    hum_res_perc_gdp = db.Column(db.Integer)
    ...
    phys_res_perc_outlays = db.Column(db.Integer)
    phys_res_perc_gdp = db.Column(db.Integer)
    ...
    net_interest_perc_outlays = db.Column(db.Integer)
    net_interest_perc_gdp = db.Column(db.Integer)

    other_funcs = db.Column(db.Integer)
    other_funcs_perc_outlays = db.Column(db.Integer)
    other_funcs_perc_gdp = db.Column(db.Integer)
